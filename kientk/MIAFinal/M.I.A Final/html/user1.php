...
<form id="form1" name="form1" method="post" action="">
 <div id="topheader">
   ...
   <div class="search_menu_banner">
     ...
     <div class="menu_area"><a href="M.I.AHome.html" class="addidea"> Home</a> <a href="#" class="loginhere">Manage</a> <a href="#" class="comments">Admin</a> <a href="M.I.ALogin.php" class="contact">';echo'<p action="userlogout.php" method="POST">Log out</p>';echo' </a></div>
   </div>
 </div>
 <div id="body_area">
...
<div class="item">
		...
		<div class="price">
		  <p><span class="new">Welcome  </span><span class="old">';echo $_SESSION['acc'];echo'</span></p></br></br></br>
							</div>
						</div>
    </div>
				</div>
