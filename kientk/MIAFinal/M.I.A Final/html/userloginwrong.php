...
<form id="form1" name="form1" method="post" action="">
 <div id="topheader">
   ...
   <div class="search_menu_banner">
     ...
     <div class="menu_area"><a href="M.I.AHome.html" class="addidea"> Home</a> <a href="#" class="loginhere">Read Online</a> <a href="M.I.ALogin.html" class="contact">Log In </a></div>
   </div>
 </div>
 <div id="body_area">
 ...
 <div id="main">
  ...
  <div id="center">
	      <div id="items">
<div class="item">
						<p>Wrong password or account click</p> <a href ="M.I.ALogin.php"><p color="green"> HERE </p></a>	
							</div>
						</div>
    </div>
				</div>
