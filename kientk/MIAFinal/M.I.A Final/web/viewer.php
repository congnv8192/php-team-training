...
<!--#endif-->
    ...
    <script type="text/javascript" >
		...
		//document.write("<h1></br></br>Your form has been submitted!</h1><h2>You entered the following data:</h2>");
		...
		<!--var link = document.getElementByName('rolink').value-->
    	<!--var DEFAULT_URL = location.search.getL10nAttributes('rolink');-->
		<!--var Linkstring = concat("'",document.getElementsByName('rolink').value,"'");-->
		var DEFAULT_URL='';//'../resources/HarryPotter6.pdf';
		var DEFAULT_URL1='';
		for (var i=0; i < formArray.length; ++i)
			DEFAULT_URL1 = formArray[i];
		for (var i=5; i < DEFAULT_URL1.length; ++i)
			DEFAULT_URL += DEFAULT_URL1[i];
		<!--var DEFAULT_URL = document.getElementsById("rolink").innerHTML;-->
		//document.writeln('the link is :',DEFAULT_URL);
    </script>  
