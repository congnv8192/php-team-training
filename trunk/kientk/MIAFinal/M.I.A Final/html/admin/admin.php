...
<form id="form1" name="form1" method="post" action="">
 <div id="topheader">
   ...
   <div class="search_menu_banner">
     ...
     <div class="menu_area"><a href="../M.I.AHome.php" class="addidea"> Home</a> <a href="adminBookAdd.html" class="loginhere">Manage</a> <a href="#" class="comments">Admin</a> <a href="adminlogin.php" class="contact">';echo'<p action="userlogout.php" method="POST">Log out</p>';echo' </a></div>
   </div>
 </div>
 <div id="body_area">
 ...
 <div id="main">
  ...
  <div id="center">
	      <div id="items">
<div class="item">
							<h5> Administrator of M.I.A eBooks</h5>
		<div class="price">
		  <p><span class="new">Admin Name: </span><span class="old">';echo $_SESSION['adacc'];echo'</span></p></br></br></br>
							</div>
						</div>
    </div>
				</div>
