...
<title>M.I.A Registration</title>
...
<form id="form1" name="form1" method="post" action="">
 <div id="topheader">
   ...
   <div class="search_menu_banner">
     ...
     <div class="menu_area"><a href="M.I.AHome.html" class="addidea"> Home</a> <a href="#" class="loginhere">Read Online</a> <a href="#" class="comments">Admin</a> <a href="M.I.ALogin.html" class="contact">Log In </a></div>
   </div>
 </div>
 <div id="body_area">
 ...
 <div id="main">
  ...
  <div class="left">
    ...
    <div class="morelinks_area">
      <div class="morelinks_head">Category </div>
      <div class="links_morearea"><a href="#" class="morelink">Adventure<span class="links_text"> books</span></a> <a href="#" class="morelink">Romance <span class="links_text">books</span></a> <a href="#" class="morelink">Comic<span class="links_text">books</span></a> <a href="#" class="morelink">Detective <span class="links_text">books</span></a> <br />
        <a href="#" class="morelink">Thriller<span class="links_text">books</span></a> <br />
        <a href="#" class="morelink">Novel <span class="links_text">books</span></a> <a href="#" class="morelink">Drama<span class="links_text">books</span></a> <br />
        <a href="#" class="morelink">Other<span class="links_text"> books</span></a><br />
      </div>
    </div>
...
<form action="checkregister.php" method ="POST"> 
			<div id="trai">Username(*): </div><input type="text" name="acc"></br></br>
			<div id="trai">Password(*): </div><input type="password"name="pass"></br></br>
        	<div id="trai">Retype Password(*): </div><input type="password" name="passretype" /></br></br>
           <div id="trai">Email Address: </div><input type="text" name="mail" /></br></br>                 
			<div id="trai"><input type="submit" value="Create Account"></div>';?>
		
                              
			<input type="reset" value=" Reset "></br></br></form>
			<form><a href= ""><p>Forgot password </p></a>
		</form>
							</div>
						</div>
    </div>
